...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [-12020111.676444, 3550160.703530, -12007301.078174, 3563999.492045],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-12020111.676444, 3550160.703530, -12007301.078174, 3563999.492045], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Producción de adobe en Casas Grandes y Nuevo Casas Grandes</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (176 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Ubicación de los establecimientos que fabrican adobes en los municipios de Casas Grandes y Nuevo Casas Grandes, activos en 2015 y/o 2025,  registrados en el DENUE por el INEGI.';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_Produccindeadobeen2015_4,
    colName: '√Årea geoestad√≠stica b√°sica ',
    zoom: 10,
    collapsed: true,
    map: map,
    maxResults: 10,
